...
about: Report an issue with the '@angular-eslint/template-parser' package
title: ''
labels: 'package: template-parser, triage'
assignees: ''
---
...
This issue template is only for problems specifically with the `@angular-eslint/template-parser` package.
That means you should only use this template if there are problems parsing your Angular Templates, not if there are issues with Template lint rules.
