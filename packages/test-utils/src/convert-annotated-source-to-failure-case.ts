 ...
 */
export const SPECIAL_UNDERLINE_CHARS = ['~', '^', '#', '%', '¶', '*', '¨', '@'] as const;
...
export function convertAnnotatedSourceToFailureCase<
  TMessageIds extends string,
  Options extends readonly unknown[],
>(errorOptions: SingleErrorOptions<TMessageIds, Options>): InvalidTestCase<TMessageIds, Options>;
export function convertAnnotatedSourceToFailureCase<
  TMessageIds extends string,
  Options extends readonly unknown[],
>(errorOptions: MultipleErrorOptions<TMessageIds, Options>): InvalidTestCase<TMessageIds, Options>;
export function convertAnnotatedSourceToFailureCase<
  TMessageIds extends string,
  Options extends readonly unknown[],
>(
  ...
  const messages: MultipleErrorOptions<TMessageIds, Options>['messages'] =
    'messageId' in errorOptions ? [{ ...errorOptions, char: '~' }] : errorOptions.messages;
  let parsedSource = '';
  ...
  return {
    ...
    code:
      ...
      process.env.GENERATING_RULE_DOCS === '1' ? errorOptions.annotatedSource : parsedSource,
