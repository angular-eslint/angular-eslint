...
| [`prefer-class-binding`](https://github.com/angular-eslint/angular-eslint/blob/main/packages/eslint-plugin-template/docs/rules/prefer-class-binding.md) | Disallows the use of ngClass in HTML templates | :white_check_mark: |  |  |  |
