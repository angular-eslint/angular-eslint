...
| [`no-inject-outside-di-context`](https://github.com/angular-eslint/angular-eslint/blob/main/packages/eslint-plugin/docs/rules/no-inject-outside-di-context.md) | Ensures that `inject()` is called in an injection context |  |  |  |
